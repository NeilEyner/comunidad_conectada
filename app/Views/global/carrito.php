                                    ...
                                    <ul class="list-inline pb-3">
                                        <li class="list-inline-item text-right">
                                            <input type="hidden" name="product-quanity" id="product-quanity"
                                                max="<?= $producto['Stock'] ?>" value="<?= $prod['Cantidad'] ?>">
                                        </li>
                                        <li class="list-inline-item"><span class="btn btn-success" id="btn-menos"
                                                onclick="menos1()">-</span></li>
                                        <li class="list-inline-item"><span class="badge bg-secondary"
                                                id="var-val"><?= $prod['Cantidad'] ?></span></li>
                                        <li class="list-inline-item"><span class="btn btn-success" id="btn-mas"
                                                onclick="mas1()">+</span></li>
                                    </ul>
                                </div>
                                <div class=" ms-auto">
                ...
                <div class="col-lg-3 mt-4 mt-lg-0">
                    <div class="cart_summary">
                        ...
                        <div class="cart_sum_pros">
                            <?php if (isset($carrito['ID'])): ?>
                                <a href="<?php echo base_url('pagos/metodo_pago/' . $carrito['ID']); ?>"
                                    class="default_btn second ms-3 w-50 px-1" style="text-decoration:none;">Pagar</a>
                            <?php else: ?>
                                <span class="default_btn second ms-3 w-50 px-1" style="opacity: 0.5;">Pagar (ID no
                                    disponible)</span>
                            <?php endif; ?>
                        </div>
