        ...
        <div class="col-lg-9">
            ...
            <div class="row" id="div-prod">
                ...
                foreach ($productos as $producto):
                    ...
                    $count++;
                    ?>
                    <div class="col-md-4 <?php foreach ($categorias as $categoria): echo 'cat-' . $categoria['ID_Categoria'] . ' ';
                    endforeach; ?>" <?php echo $hidden ?> name="prod">
                        <div class="card mb-4 product-wap rounded">
                            <div class="card rounded">
                                <img class="card-img rounded img-fluid" src="<?= $producto['Imagen_URL'] ?>" style="width: 100%; height: 250px; object-fit:cover;" >
