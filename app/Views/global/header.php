                                ...
                                <div class="shopcart_dropdown" id='carrito-m'>
                                    ...
                                    if ($carrito != null) {
                                            ...
                                            <div class="cartsdrop_wrap">
                                                <a href="" class="single_cartdrop mb-3" style="text-decoration:none">
                                                    ...
                                                    <div class="cartdrop_cont">
                                                        ...
                                                        <p class="mb-0 text_xs text_p">x<?= $prod['Cantidad'] ?> <span
                                                                class="ms-2"><?= $producto['Precio'] ?></span></p>
                                                    </div>
                                                </a>
                                            </div>
                                        ...
                                        <div class="d-flex mt-3">
                                            <a href="<?= base_url('carrito') ?>" class="default_btn w-50 px-1"
                                                style="text-decoration:none;">Ver Carrito</a>
                                            <?php if (isset($carrito['ID'])): ?>
                                                <a href="<?= base_url('pagos/metodo_pago/' . $carrito['ID']); ?>"
