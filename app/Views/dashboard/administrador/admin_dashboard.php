    ...
    <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
      ...
      <div class="card flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
        ...
        <div>
          ...
          <p class="text-lg font-semibold text-gray-700 dark:text-gray-200"><?php echo count($usuarios); ?></p>
        </div>
      </div>
      ...
      <div class="card flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
        ...
        <div>
          <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">TOTAL COMPRAS</p>
          <p class="text-lg font-semibold text-gray-700 dark:text-gray-200"><?php echo count($compras); ?></p>
        </div>
      </div>
      ...
      <div class="card flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
        ...
        <div>
          <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">TOTAL DE ENVIOS</p>
          <p class="text-lg font-semibold text-gray-700 dark:text-gray-200"><?php echo count($envios); ?></p>
        </div>
      </div>
    </div>
                  ...
                  <td class="px-4 py-3 text-xs">
                    <span class="
                      ...
                      switch ($evento['Tipo_Evento']) {
                        case 'INICIO_SESION':
                          echo 'text-blue-700 bg-blue-100 dark:bg-blue-700 dark:text-blue-100';
                          break;
                        case 'CIERRE_SESION':
                          echo 'text-red-700 bg-red-100 dark:bg-red-700 dark:text-red-100';
                          break;
                        case 'COMPRA':
                          echo 'text-green-700 bg-green-100 dark:bg-green-700 dark:text-green-100';
                          break;
                        case 'CAMBIO_PERFIL':
                          echo 'text-yellow-700 bg-yellow-100 dark:bg-yellow-700 dark:text-yellow-100';
                          break;
                        case 'SEGURIDAD':
                          echo 'text-purple-700 bg-purple-100 dark:bg-purple-700 dark:text-purple-100';
                          break;
                        case 'SISTEMA':
                          echo 'text-gray-700 bg-gray-100 dark:bg-gray-700 dark:text-gray-100';
                          break;
                        default:
                          echo 'text-gray-600 bg-gray-200 dark:bg-gray-800 dark:text-gray-400';
                          break;
                      }
                      ?>
                    ">
