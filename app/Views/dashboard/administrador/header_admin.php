    ...
    >
      ...
      <aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0" >
        <div class="py-4 text-gray-500 dark:text-gray-400">
          <a class="ml-6 text-lg font-bold text-gray-800 dark:text-gray-200" href="<?= base_url()?>" > REGRESAR A LA PAGINA </a>
          <ul class="mt-6">
            <li class="relative px-6 py-3">
              <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
                href="<?=base_url()?>dashboard/administrador/admin_dashboard" >
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
                  fill="none"
          ...
          <ul >
            <li class="relative px-6 py-3"> 
              <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="<?=base_url()?>dashboard/administrador/admin_usuarios">
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
                  fill="none"
