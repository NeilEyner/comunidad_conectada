          ...
          <ul >
            <li class="relative px-6 py-3"> 
              <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="<?=base_url()?>dashboard/artesano/arte_productos">
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
                  fill="none"
            ...
            <li class="relative px-6 py-3 ">
              <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="<?=base_url()?>dashboard/artesano/arte_pedidos" >
                <svg class="w-5 h-5"
                  aria-hidden="true"
                  fill="none"
                  stroke-linecap="round"
            ...
            <li class="relative px-6 py-3 ">
              <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="<?=base_url()?>dashboard/artesano/arte_inventario" >
                <svg class="w-5 h-5"
                  aria-hidden="true"
                  fill="none"
                  stroke-linecap="round"
            ...
            <li class="relative px-6 py-3 ">
              <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="<?=base_url()?>dashboard/artesano/arte_valoracion" >
                <svg class="w-5 h-5"
                  aria-hidden="true"
                  fill="none"
                  stroke-linecap="round"
