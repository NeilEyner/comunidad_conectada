                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <script>
                                                        var lat = <?= $lat ?>;
                                                        var lng = <?= $lng ?>;
                                                        var mapId = 'map_<?= $producto['ID_Producto'] ?>'; // ID único para cada mapa
                        ...
                        <!-- <div class="modal-footer">
                            ...
                            <?php if ($envio['Estado'] != 'ENTREGADO'): ?>
                                <button type="button" class="btn btn-success"
                                    onclick="confirmarEntrega(<?= $envio['ID_Compra'] ?>)">
                                    <i class="ri-check-line me-1"></i>Confirmar Entrega
                                </button>
                            <?php endif; ?>
                        </div> -->
