        ...
        <div class="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
          ...
          <div class="bg-gray-100 px-4 py-3 border-b border-gray-200 flex items-center justify-between">
            <div class="flex items-center space-x-3">
              <!-- <span class="px-3 py-1 bg-purple-100 text-purple-700 rounded-lg font-semibold text-sm">
                #<?= $envio['ID_Compra'] ?>
              </span> -->
            ...
            <!-- application/views/asignar_envio.php -->
            <form action="<?= base_url('envios/asignar') ?>" method="POST">
              <input type="hidden" name="id_compra" value="<?= $envio['ID_Compra'] ?>">
              <button type="submit"
                class="bg-blue-500 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded-lg shadow-md transition duration-200 ease-in-out transform hover:scale-105">
                Asignar Envío
              </button>
            </form>
